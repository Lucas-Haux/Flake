...
in
{
  "theme.osd.border.color" = content;
  "theme.osd.bar_color" = content;
  "theme.osd.bar_container" = barModuleBackground;
  "theme.osd.bar_empty_color" = darkBackground;
  "theme.osd.bar_overflow_color" = error;
  "theme.osd.icon_container" = barModuleBorder;
  "theme.ods.icon" = content;
  "theme.ods.label" = content;

  "theme.notification.actions.background" = menuBackground;
  "theme.notification.actions.text" = content;
  "theme.notification.background" = menuBackground;
  "theme.notification.border" = menuBorder;
  "theme.notification.close_button.background" = error;
  "theme.notification.close_button.label" = "#2e3440";
  "theme.notification.label" = content;
  "theme.notification.labelicon" = content;
  "theme.notification.text" = "#d8dee9";
  "theme.notification.time" = "#b48ead";

  "menus.dashboard.powermenu.avatar.image" = "/home/luke/Media/pictures/nixos.png";
