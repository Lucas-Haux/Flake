{ lib, config, ... }:
{
  wayland.windowManager.hyprland.extraConfig = # hyprlang
    ''
      ...
      # windowrulev2 = noscreenshare, class(keepassxc)
      ...
      # windowrulev2 = noscreenshare, class:(android-messages-desktop)
      ...
      windowrulev2 = center=1, class:(chrome-t3.chat__-Default)
      windowrulev2 = size 65% 90%, class:(chrome-t3.chat__-Default)
      windowrulev2 = opacity 0.75 0.75, class:(chrome-t3.chat__-Default)
      windowrulev2 = stayfocused, class:(chrome-t3.chat__-Default)
      windowrulev2 = bordercolor rgba(${lib.removePrefix "#" config.colorscheme.colors.base0E}cc), class:(chrome-t3.chat__-Default)
      # windowrulev2 = noscreenshare, class:(chrome-t3.chat__-Default)
